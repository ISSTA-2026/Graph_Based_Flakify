...
for i in project_name:
    ...
    X_train, X_valid, y_train, y_valid=train_test_split(train_dataset[x], train_dataset[y], random_state=seed, test_size=0.2, stratify=train_dataset[y])
    ...
    test_item = TextDataset(model_tokenizer, test_df['code'], y_test['flaky'].values)
